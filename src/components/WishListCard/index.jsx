...
export function WishListCard ({ image, id, price, name }) {
  return (
    <Flex bg='white' mt='1rem' mb='1rem' h={[]} maxWidth={['21rem', '24rem', '58rem']} minHeight='10rem' flexDirection='column' boxShadow='md'>
      <Flex mr='1.6rem' ml='2.3rem' justifyContent={['space-around', 'space-around', 'space-around', 'flex-start']} h={['18rem', '13rem', '13rem', '10rem']} mt='1.6rem' flexDirection={['column', 'column', 'column', 'row']}>
        ...
        <Text mr='6.5rem' w={['17.7rem', '17.7rem', '21.8rem']} textOverflow='ellipsis' overflow='hidden'>{name}</Text>
        <Text textAlign={['flex-start', 'flex-start', 'center']} w='6.2rem' fontSize={['1rem', '1rem', '1.2rem']} ml={['0rem', '0rem', '18.7rem']} fontWeight={['bold', 'none', 'none']}>${price}</Text>
      </Flex>
