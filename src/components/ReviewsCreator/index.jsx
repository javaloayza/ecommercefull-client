...
export default function Reviews () {
  ...
  return (
    <div>
      {/* <h1>{productName}</h1> */}
      <Box display='flex' justifyContent='center' alignItems='center' p={['1rem', '1rem', '7rem', '7rem']} minH='72vh'>
        <Box display='flex' flexDirection='column' gap='1rem'>
          ...
          <Textarea width={['320px', '400px', '400px']} placeholder='Deja tu comentario' onChange={handleInputChange} name='review' />
          {/* botones */}
