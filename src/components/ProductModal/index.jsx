...
function ProductModal ({ isOpen, onClose, product, setProduct }) {
  ...
  /**
  * If the product.image array is empty, return an empty string. If the first element in the array is a
  * string, return a comma separated list of the file names. If the first element in the array is a
  * File object, return a comma separated list of the file names
  * The imageValue function is returning the name of the image file.
  */
  const imageValue = () => {
  ...
  const handleImageChange = (e) => {
    ...
    /* This is a function that is checking if the image array is empty. If it is empty, it will return.
    If the image array is not empty, it will check if the image is a file. If it is not a file, it
    will set an error. If it is a file, it will set the product image. */
