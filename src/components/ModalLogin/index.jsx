...
import { signInWithEmailAndPassword, onAuthStateChanged, signInWithPopup, GoogleAuthProvider, createUserWithEmailAndPassword } from 'firebase/auth'
...
export const ModalLogin = ({ children, state, setState, isRegistrando, setIsRegistrando }) => {
  ...
  useEffect(() => {
    /* A listener that is listening for changes in the user's authentication state. */
