  ...
  return (
    <Flex flexDirection='column' justifyContent='center'>
      <Flex mt='1rem' flexDirection='column' justifyContent='center' alignItems='center'>
        <Tabs w={['22rem', '22rem', '25rem', '61.3rem']}>
          ...
          <TabPanels>
            <TabPanel>
              <CartItemContainer />
              <Flex w={['22rem', '22rem', '25rem', '61.3rem']} flexDirection='column' justifyContent='center' alignItems='flex-end'>
                {totalProductCount > 0 &&
                  <>
                    <Text mt={['1.5rem', '1.5rem', '3.4rem']} mb={['1.5rem', '1.5rem', '3.4rem']} fontSize={['1.3rem', '1.3rem', '1.5rem']}>Total: ${totalProductCount} </Text>
